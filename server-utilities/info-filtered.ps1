...
$runningServices = Get-Service | Where-Object {$_.Status -eq "Running" -and $_.DisplayName -notmatch "^@|^Microsoft|Service Control Manager|^Windows"}
...
$startupServices = Get-CimInstance -ClassName Win32_Service | Where-Object {$_.StartMode -eq "Auto" -and $_.DisplayName -notmatch "^@|^Microsoft|Service Control Manager|^Windows"}}
